...
* Once subscribed and [Now Push Notify App](https://apps.apple.com/gb/app/now-push/id1522227211) installed, your visitors will get a notification when you publish a new post/page (including custom posts).

NOTE: Push notification data (your WordPress site title, post title, post URL, post thumbnail) is sent to the Now Push Notify API, i.e. https://notifyapi.nowpush.app when a new notification is generated in order for your subscribers to get the update. Our [terms of use](https://nowpush.app/terms-and-conditions.html) and [privacy policy](https://nowpush.app/privacy_policy.html) apply.
...
*Now Push Notify runs on AWS and Firebase, but we do not store any data beyond your verified Domains, your user email address for login and for the Notifications you send, we do store the URLs, the title and the body of the Notifications, this data is stored on Firebase.*
